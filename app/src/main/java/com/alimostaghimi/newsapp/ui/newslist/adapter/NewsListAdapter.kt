package com.alimostaghimi.newsapp.ui.newslist.adapter
...
class NewsListAdapter(private val newsList: ArrayList<News>) : RecyclerView.Adapter<NewsListAdapter.DataViewHolder>() {
    ...
    class DataViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(news: News) {
            ...
            itemView.setOnClickListener {
                ...
                val costumeTabsIntent = builder.build()
                costumeTabsIntent.launchUrl(it.context, Uri.parse(news.url))
